(module
  ...
  (data (i32.const 128) "0123456789ABCDEF") ;; template
  ...
  (func (export "to_string") (param $num i32)
    (call $set_dec_string (local.get $num) (global.get $dec_string_len)) ;; write string to location 256
    (call $print_string (i32.const 256) (global.get $dec_string_len))    ;; print string at location 256
    
    (call $set_hex_string (local.get $num) (global.get $hex_string_len)) ;; write string to location 384
    (call $print_string (i32.const 384) (global.get $hex_string_len))    ;; print string at location 384

    (call $set_bin_string (local.get $num) (global.get $bin_string_len)) ;; write string to location 512
    (call $print_string (i32.const 512) (global.get $bin_string_len))    ;; print string at location 512
  )
)